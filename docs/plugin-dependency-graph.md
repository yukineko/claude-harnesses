...
> `crates/condukt/skills/condukt/SKILL.md:951` "tdd/specguard を経路面") — that mention is a
...
> `crates/condukt/skills/condukt/SKILL.md:867` "tdd oracle --task". See the scope limit below.
...
- **`tdd`** is a leaf **under this doc's edge rule only** (SKILL/agent-file
  ...
  `crates/condukt/skills/condukt/SKILL.md:951` "tdd/specguard を経路面" and issues no bash call to it —
