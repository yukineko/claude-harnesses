...
既定の target は fleet の **GATE crates** (blastguard/propguard/specguard/stuckguard/mutategate/overwatch/parallelguard =
...
`blastguard,propguard,specguard,stuckguard,mutategate,overwatch,parallelguard,backlog`
